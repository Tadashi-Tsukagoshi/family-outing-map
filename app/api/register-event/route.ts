...
export async function POST(req: Request) {
  ...
  const newEvent = {
    ...
    sub_category:  (b.sub_category as string | undefined) ?? null,
    group_id:      (b.group_id as string | undefined) ?? null,
    type,
  ...
  const responseEvent: CollectedEvent = {
    ...
    subCategory: newEvent.sub_category ?? undefined,
    groupId:     newEvent.group_id ?? undefined,
    type:        newEvent.type,
